...
def data(request):
    ...
    absolute_latest_timestamp_obj = ramanadhapuram_forecast.objects.aggregate(Max('timestamp')) # Using ramanadhapuram_forecast model
    ...
    if absolute_latest_timestamp:
        ...
        latest_cloud_data = ramanadhapuram_forecast.objects.filter( # Using ramanadhapuram_forecast model
