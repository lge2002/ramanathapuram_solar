...
def report_view(request):
    ...
    # --- Filtering ramanadhapuram_forecast data for display ---
    cloud_analysis_query = ramanadhapuram_forecast.objects.filter(
...
def download_report_pdf(request):
    ...
    cloud_analysis_query_pdf = ramanadhapuram_forecast.objects.filter(
